...
/root/glm-ocr-sdk/         # GLM-OCR SDK 소스
/root/OmniDocBench/        # OmniDocBench 공식 평가 코드
/root/junghoon/miner_test/ # MinerU 설치
```
...
| **SDK** | `/root/glm-ocr-sdk/` (`glmocr` 패키지) |
...
**위치**: `/root/glm-ocr-sdk/`
**설정 파일**: `/root/glm-ocr-sdk/glmocr/config.yaml`
...
**파일**: `/root/OmniDocBench/metrics/table_metric.py`
...
**파일**: `/root/OmniDocBench/metrics/cdm_metric.py`
...
*결과 파일 위치: `/root/ocr_test/results/`*
