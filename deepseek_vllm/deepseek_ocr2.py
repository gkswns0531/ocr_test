...
Adapted from official DeepSeek-OCR2-vllm repo:
- Import paths changed to use deepseek_vllm package
- Config globals replaced with constants
"""
import math
...
from vllm.transformers_utils.configs.deepseek_vl2 import (DeepseekVLV2Config,
                                                          MlpProjectorConfig,
                                                          VisionEncoderConfig)
from deepseek_vllm.image_process import (
...
from deepseek_vllm.deepencoderv2.sam_vary_sdpa import build_sam_vit_b
from deepseek_vllm.deepencoderv2.qwen2_d2e import build_qwen2_decoder_as_encoder
from deepseek_vllm.deepencoderv2.build_linear import MlpProjector
from addict import Dict

from deepseek_vllm.constants import IMAGE_SIZE, BASE_SIZE, CROP_MODE, PRINT_NUM_VIS_TOKENS, DEFAULT_PROMPT
        ...
        if '<image>' in DEFAULT_PROMPT:
            ...
            return {
                ...
                processor.tokenize_with_images(
                    ...
                    bos=True, eos=True, cropping=CROP_MODE)
            }
        else:
            return {
                "image": []
